...
CREATE INDEX IX_Experiment_ExperimentGroupId
  ON mq.Experiment (ExperimentGroupId);
...
CREATE INDEX IX_RawFile_ExperimentId
  ON mq.RawFile (ExperimentId);
...
CREATE INDEX IX_ProteinGroup_ExperimentGroupId
  ON mq.ProteinGroup (ExperimentGroupId);
...
CREATE INDEX IX_ProteinGroupExperimentInfo_ExperimentId
  ON mq.ProteinGroupExperimentInfo (ExperimentId);
CREATE INDEX IX_ProteinGroupExperimentInfo_ProteinGroupId
  ON mq.ProteinGroupExperimentInfo (ProteinGroupId);
...
CREATE INDEX IX_ProteinGroupIntensitySilac_ExperimentId
  ON mq.ProteinGroupIntensitySilac (ExperimentId);
CREATE INDEX IX_ProteinGroupIntensitySilac_ProteinGroupId
  ON mq.ProteinGroupIntensitySilac (ProteinGroupId);
...
CREATE INDEX IX_ProteinGroupRatiosSilac_ExperimentId
  ON mq.ProteinGroupRatiosSilac (ExperimentId);
CREATE INDEX IX_ProteinGroupRatiosSilac_ProteinGroupId
  ON mq.ProteinGroupRatiosSilac (ProteinGroupId);
...
CREATE INDEX IX_Peptide_ExperimentGroupId
  ON mq.Peptide (ExperimentGroupId);
...
CREATE INDEX IX_ProteinGroupPeptide_ProteinGroupId
  ON mq.ProteinGroupPeptide (ProteinGroupId);
CREATE INDEX IX_ProteinGroupPeptide_PeptideId
  ON mq.ProteinGroupPeptide (PeptideId);
...
CREATE INDEX IX_ModifiedPeptide_PeptideId
  ON mq.ModifiedPeptide (PeptideId);
...
CREATE INDEX IX_Evidence_PeptideId
  ON mq.Evidence (PeptideId);
CREATE INDEX IX_Evidence_ModifiedPeptideId
  ON mq.Evidence (ModifiedPeptideId);
CREATE INDEX IX_Evidence_ExperimentId
  ON mq.Evidence (ExperimentId);
CREATE INDEX IX_Evidence_RawFileId
  ON mq.Evidence (RawFileId);
...
CREATE INDEX IX_EvidenceIntensitySilac_EvidenceId
  ON mq.EvidenceIntensitySilac (EvidenceId);
...
DROP INDEX IX_EvidenceTMT_EvidenceId ON mq.EvidenceTMT;
DROP INDEX IX_ModifiedPeptideTMT_ModifiedPeptideId ON mq.ModifiedPeptideTMT;